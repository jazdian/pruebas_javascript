...
class DataTable
{
    ...
    public function SetBtnSelect($btnSelect_)
    {
        ...
        if (!array_key_exists('name', $btnSelect_)) {$btnSelect_['name'] = "Select";}
    ...
    public function SetBtnEdit($btnEdit_)
    {
        ...
        if (!array_key_exists('name', $btnEdit_)) {$btnEdit_['name'] = "Edit";}
    ...
    public function SetBtnDelete($btnDelete_)
    {
        ...
        if (!array_key_exists('name', $btnDelete_)) {$btnDelete_['name'] = "Delete";}
    ...
    private function CreateHead()
    {
        ...
        if ($numHeader === 0) {
            ...
            if ($msgErr !== '') {
                $HeadTable .= '<th>.: Error :.</th></tr></thead>';
                return $HeadTable;
            }
    ...
    private function CreatBody()
    {
        ...
        $msgErr = $this->ValidateObject($this->datasource);
        if ($msgErr !== '') {
            $BodyTable .= '<tr><td>Error: ' . $msgErr . '</td></tr></tbody>';
            return $BodyTable;
        }
